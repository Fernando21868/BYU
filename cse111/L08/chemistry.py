def main():
    ...
    # store the molecule in a variable.
    molecule = get_formula_name(formula, known_molecules_dict)
    # Finding formula in known_molecules_dict
    print(molecule)
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    total_molar_mass = 0
    for dict in symbol_quantity_list:
        symbol = dict[SYMBOL_INDEX]
        quantity = dict[QUANTITY_INDEX]
        if symbol in periodic_table_dict:
